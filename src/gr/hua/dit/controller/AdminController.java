...
public class AdminController {
	...
	public String AddedService(HttpServletRequest request, HttpServletResponse res)
		...
		String documentManager = request.getParameter("documentmanager");
		String administrator = request.getParameter("administrator");
		String studentManager = request.getParameter("studentmanager");
		AdminService.AddService(service,supervisor, documentManager, studentManager, administrator);
