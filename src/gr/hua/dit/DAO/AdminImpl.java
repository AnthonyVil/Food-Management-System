...
//		}
	...
	public void AddService(String service,String supervisor,String documentManager,String studentManager,String administrator) {
		...
		Permissions permission = new Permissions(service,supervisor, documentManager, studentManager, administrator);
	...
	public void UpdateService (String column, String newValue, String existService) {
		...
		} else if(column.equals("supervisor")) {
			queryStr = "update from Permissions set supervisor = ? where services = ?";
		} else if(column.equals("studentmanager")) {
			queryStr = "update from Permissions set student_manager = ? where services = ?";
		} else if(column.equals("administrator")) {
			queryStr = "update from Permissions set administrator = ? where services = ?";
		}else if(column.equals("documentmanager")) {
			queryStr = "update from Permissions set document_manager = ? where services = ?";
		}
